        ...
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-5">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h2>Choose which type of account you want</h2>
                </div>
            </div>
        </div>
        ...
        <div class="icon-boxes position-relative" data-aos="fade-up" data-aos-delay="200" id="options">
            <div class="container position-relative">
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <?php echo "<h4 class='title'><a href='admin.php?id=$id' class='stretched-link'>Teachers</a></h4>";?>
                    </div>
                </div><!--End Icon Box -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <?php echo "<h4 class='title'><a href='home.php?id=$id' class='stretched-link'>Students</a></h4>";?>
                    </div>
                </div><!--End Icon Box -->
