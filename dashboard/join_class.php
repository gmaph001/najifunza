...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="login-form">
            ...
            <!-- Login Form -->
            <?php echo "<form class='login' action='join.php?id=$id&&class=$class' method='POST' enctype='multipart/form-data'>";?>
                <center><h2>Join Class</h2></center>
                <div class="inputs">
                ...
                <div class="login-btns">
                    <button type="submit" name="join" class="btn submit">Join Class</button>
                </div>
            </form>
            <!-- Login Form -->
