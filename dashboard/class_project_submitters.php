<?php
    ...
    if($result2){
        for($i=0; $i<mysqli_num_rows($result2); $i++){
            ...
            if($class === $row['class'] && $id === $row['poster'] && $assign === $row['proj_key']){
    ...
    if($result3){
        for($i=0; $i<mysqli_num_rows($result3); $i++){
            ...
            if($class === $row['class'] && $assign === $row['proj_key']){
                ...
                if($size == 0){
                    ...
                    for($i=$size-1; $i>=0; $i--){
                        if($submitter[$i] === "repeated"){
                            ...
                            $query6 = "SELECT * FROM class_project_submissions";
                            ...
                            if($result6){
                                for($w=0; $w<mysqli_num_rows($result6); $w++){
                                    ...
                                    if($stdnt === $row2['submitter'] && $assign === $row2['proj_key'] && $class === $row2['class']){
                                        $sub_key = $row2['sub_key'];
                                        $sub_date = $row2['sub_date'];
                                        $submission = $row2['link'];
                                        ...
                                        "
                                            <div class='material'>
                                                ...
                                                <a href='../$submission' target='_blank' class='views'>View</a><br><br>
                                                <a onclick=";?> "linkcpy('<?php echo "localhost/najifunza/ad.php?key=$sub_key";?> ')" <?php echo " class='views'>Copy Link</a>
                                            </div>
                                        ";
                                    }
                                }
