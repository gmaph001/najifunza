...
<head>
  ...
  <title>NAJIFUNZA | Class Assignment</title>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Assignment Panel</h5>

                            <!-- Floating Labels Form -->
                            <?php echo "<form class='row g-3' method='POST' action='upload_class_assignment.php?id=$id&&class=$class' enctype='multipart/form-data'>";?>
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="fname" name="name" placeholder="Assignment Name" required>
                                        <label for="floatingName">Assignment Name</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="ddate" name="due" required>
                                        <label for="floatingTextarea">Due Date</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="file" class="form-control" name="assignment" id="assigned" onchange="filetype()" accept=".pdf,.doc,.docx" required>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <span>Do you want your assignment to be submitted within the platform?</span>&nbsp;&nbsp;
                                        <input class="subCheck" type="checkbox" name="submission" value="submit" id="resub" onclick="chksubmit()">
                                    </div>
                                </div>
                                <div class="col-12 ifsubmitted">
                                    <div class="form-floating mb-3">
                                        <p>Which format do you want your assignment to be submitted?</p>
                                        <select class="form-select" name="format" id="fmt">
                                            <option selected value="none">Choose Format</option>
                                            <option value="document">Document Format</option>
                                            ...
                                            <option value="photo">Photo Format</option>
