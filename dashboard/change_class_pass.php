...
<head>
    ...
    <title>NAJIFUNZA | Class Verification</title>
...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="login-form">
            ...
            <!-- Login Form -->
            <?php echo "<form class='login' action='password_reset_class.php?id=$id&&class=$class' method='POST' enctype='multipart/form-data'>";?>
                <center><h2>Reset Class Password</h2></center>
                <div class="inputs">
                    <label for="inputPassword4" class="form-label">New Class Password</label>
                ...
                <div class="login-btns">
                    <button type="submit" name="create" class="btn submit" onclick="unda()">Reset Password</button>
                </div>
            </form>
            <!-- Login Form -->
