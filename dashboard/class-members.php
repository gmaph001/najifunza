        ...
        for($i=0; $i<mysqli_num_rows($result3); $i++){
            ...
            if($class === $row['class_key']){
                ...
                for($j=0; $j<mysqli_num_rows($result4); $j++){
                    ...
                    if($key[$size] === $row2['userkey']){
                        $user[$size] = $row2['username'];
                    }
                }
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <li class="nav-item">
            <?php echo "<a class='nav-link ' href='class-members.php?id=$id&&class=$class'>";?>
            <i class="bi bi-person"></i>
        ...
        <section class="section">
            ...
            <?php
                if($size>0){
                    echo
                    "
                        <div class='row align-items-horizontal members'>
                    ";
                    for($i=$size-1; $i>=0; $i--){
                        $no++;
                        echo 
                        "
                            <div class='popUp' id='$i'>
                                <div class='delete_popUp'>
                                    <p>Are you sure you want to remove <b>$user[$i]</b>?</p>

                                    <div class='top_btns'>
                                        <a href='delete_class_user.php?id=$id&&class=$class&&key=$key[$i]' class='btn btn-primary remove'>Yes, remove</a>
                    ...
                    "
                        <div class='unavailable'>
                            <p>Sorry! You have no any members yet!</p>
                        </div>
                    ";
                }
            ?>
