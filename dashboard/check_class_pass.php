                        ...
                        if($result){
                            for($i=0; $i<mysqli_num_rows($result); $i++){
                                ...
                                if($id === $row['userkey']){
                                    ...
                                    if($success){
                                        header("location:change_class_pass.php?id=$id&&class=$class");
                                    }
                                    else{
                                        echo "Incorrect password! Please, <a href='reset_class_pass.php?id=$id&&class=$class'><b><i>Try Again</i></b></a>";
                                    }
                                }
                            }
                        }
