            ...
            <div class="message">
                <p>
                    <?php
                        ...
                        $querydel = "SELECT * FROM class_activity";
                        ...
                        if($resultdel){
                            for($i=0; $i<mysqli_num_rows($resultdel); $i++){
                                ...
                                if($id === $row['userkey'] && $key === $row['mat_key'] && $class === $row['class_key']){
                                    $notes = $row['mat_name'];

                                    if(file_exists("../".$notes)){
                                        $success = unlink("../".$notes);

                                        if($success){
                                            $query = "DELETE FROM class_activity WHERE mat_key = '$key'";
