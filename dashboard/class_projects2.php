    ...
    if($result2){
        for($i=0; $i<mysqli_num_rows($result2); $i++){
            ...
            if($class === $row['class']){
                ...
                $proj_type[$size] = $row['proj_type'];
                $proof[$size] = $row['proj_proof'];
                $documentation[$size] = $row['documentation'];
                $proj_due[$size] = $row['proj_due'];
                $proj_key[$size] = $row['proj_key'];
                $size++;
            }
        }
    }
        ...
        <div class="sidebar">
            ...
            <?php
                ...
                "
                    ...
                    <a class='option' href='class_projects2.php?id=$id&&class=$class' onmouseover='optshow(4)' onmouseleave='opthide(4)'>
                        <img src='../media/icons/project2.png' class='icon'>
                ...
                <div class="menubar">
                    ...
                    <?php
                        ...
                        "
                            ...
                            <a href='class_projects2.php?id=$id' class='nav-option'>Projects</a><hr>
