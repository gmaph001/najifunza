                            ...
                            for($i=0; $i<mysqli_num_rows($result); $i++){
                                ...
                                if($id === $row['creator']){
                                    if($class === $row['class_key']){
                                        $query2 = "UPDATE classes SET class_name = '$classname' WHERE class_key = '$class'";
                                        ...
                                        if($result2){
                                            ...
                                            echo "Error while updating class name!";
                                        }
                                    }
                                    else{
                                        echo "Sorry! You are trying to update a class you have not created!";
                                    }
                                }
                                else{
                                    echo "Sorry! You have no authority to update this class' name!";
                                }
                            }
                        }
                    }
