                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo "<form class='row g-3' method='POST' action='upload_class_notes.php?id=$id&&class=$class' enctype='multipart/form-data'>";?>
                                <div class="col-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 category">
                                        <select class="form-select" id="category" aria-label="State" name="cat" onclick="masomo()">
