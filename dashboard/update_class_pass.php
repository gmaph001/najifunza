                            ...
                            for($i=0; $i<mysqli_num_rows($result); $i++){
                                ...
                                if($class === $row['class_key']){
                                    if(password_verify($old, $hashed)){
                                        ...
                                        $query2 = "UPDATE classes SET password = '$password' WHERE class_key = '$class'";
                                        ...
                                        echo "You have entered incorrect old password! Please, <br> <a href='myclass.php?id=$id&&class=$class'><b><i>Try Again</i></b></a>";
                                    }
                                }
                            }
                        }
