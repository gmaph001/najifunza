...
<head>
    ...
    <title>NAJIFUNZA | Students</title>
        ...
        <div class="icon-boxes position-relative" data-aos="fade-up" data-aos-delay="200" id="options">
            ...
            <div class="row gy-4 mt-5">
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="teachers.html#options" class="stretched-link">Primary</a></h4>
                </div>
                </div><!--End Icon Box -->
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="secondary.html#options" class="stretched-link">Secondary</a></h4>
                </div>
                </div><!--End Icon Box -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <h4 class="title"><a href="students.html#options" class="stretched-link">College/Uni</a></h4>
                    </div>
                </div><!--End Icon Box -->
