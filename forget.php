...
<head>
    ...
    <title>NAJIFUNZA | Account Verification</title>
...
<body class="index-page">
    ...
    <main class="main">
        ...
        <div class="login-form">
            ...
            <!-- Login Form -->
            <?php echo "<form class='login' action='password.php?id=$id' method='POST' enctype='multipart/form-data'>";?>
                <center><h2>User Confirmation</h2></center>
                <div class="inputs">
