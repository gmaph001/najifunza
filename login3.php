<?php
    ...
    if(isset($_POST['login'])){
        ...
        if(mysqli_num_rows($result1)>0){
            ...
            $message = "There is no user yet, please<br> <a href='login2.php?class=$class&&lev=$lev&&cat=$cat&&subject=$subject'><b><i>Sign Up!</i></b></a>";
        }
        

        if($message === "none"){
            if(!$exist){
                $message = "Incorrect username/password! Please, <br> <a href='login2.php?class=$class&&lev=$lev&&cat=$cat&&subject=$subject'><b><i>Try Again!</i></b></a>";
            }
        }
