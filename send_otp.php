          ...
          <div class="message">
               <p>
                    <?php
                                   ...
                                   if($email === $row['email']){
                                        ...
                                        try {
                                             ...
                                             $mail->Body    = "
                                                  ...
                                                  <h2>{$key}</h2>
                                                  <p>If you are getting this email, it means that someone is trying to change your password! Be alert!</p>
                                             ";
                                             
                                             if ($mail->send()) {
                                                  
                                                  if($result2){
                                                       header("location:forget.php?id=$id");
                                                  }
                                                  else{
                                                       $message .= "There was an error!<br>";
                                                  }
                                             } else {
                                                  $message .= "Key could not be sent. <br> <b>Mailer Error: {$mail->ErrorInfo}</b><br>";
                                             }
                                        } catch (Exception $e) {
                                             $message .= "Key could not be sent. <br> <b>Mailer Error: {$mail->ErrorInfo}</b><br>";
                                        }
                         ...
                         if(!$exist){
                            echo "The email does not exist! Please, <br> <a href='email.html'><b><i>Try Again</i></b></a>";
                         }
