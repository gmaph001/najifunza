...
<head>
    ...
    <title>NAJIFUNZA | Teachers</title>
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <?php echo "<a href='dashboard/admin-account.php?id=$id' class='logo d-flex align-items-center'>";?>
        ...
        <div class="icon-boxes position-relative" data-aos="fade-up" data-aos-delay="200" id="options">
            ...
            <div class="row gy-4 mt-5">
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="lessons.html#options" class="stretched-link">Lesson Plan</a></h4>
                </div>
                </div><!--End Icon Box -->
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="plan.html#options" class="stretched-link">Worksheet</a></h4>
                </div>
                </div><!--End Icon Box -->
